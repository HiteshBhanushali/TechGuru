  ...
  return (
    <div>
      ...
      <main className="min-h-screen">
        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            <h1 className="text-3xl font-bold text-primary">TechGuru</h1>
        ...
        <section id="features" className="py-16 bg-white px-6 md:px-0">
          <div className="container mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-gray-800">
              Our TechGuru platform offers a range of powerful features:
            </p>
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-blue-100 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">Mock Interviews</h3>
              ...
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  <p className="text-gray-600">
                    "The mock interviews were incredibly helpful. I felt much more confident going into my real interview."
                  </p>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 TechGuru. All rights reserved.</p>
      </footer>
    </div>
  )
}
